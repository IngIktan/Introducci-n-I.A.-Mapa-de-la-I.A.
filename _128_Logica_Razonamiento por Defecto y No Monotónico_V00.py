...
# Descripción: Ejemplo adicional de razonamiento por defecto y no monotónico utilizando PyKnow
class Accion:
    def __init__(self, nombre, precondiciones, efectos):
        self.nombre = nombre  # Nombre de la acción
        self.precondiciones = precondiciones  # Precondiciones necesarias para que la acción sea aplicable
        self.efectos = efectos  # Efectos que tiene la acción sobre el estado

    def es_aplicable(self, estado):
        # Comprueba si las precondiciones de la acción son satisfechas por el estado actual
