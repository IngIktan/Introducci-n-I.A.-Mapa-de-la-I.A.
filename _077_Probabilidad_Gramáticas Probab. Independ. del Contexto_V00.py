...
# Este programa implementa una gramática probabilística independiente del contexto utilizando NLTK.

import nltk

# Definimos una gramática probabilística independiente del contexto
